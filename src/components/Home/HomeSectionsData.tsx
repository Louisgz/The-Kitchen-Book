...
const sections = [
  {
    ...
    path: "/entrees",
    imageAlt: "Entrées",
    colors: ["rgba(54, 121, 13, .77)", "#36790D"],
    descriptions: [
      {
        image: Accueil_haricots,
        alt: "Haricots",
        text: "Les haricots verts se dégustent pendant les mois de juin, juillet et août. En primeur ils se consomment en mai et septembre. Ils peuvent se déguster froids en salade, avec des poivrons, des anchois, des olives... Chauds, ils constituent un accompagnement savoureux et léger pour les viandes et les poissons.",
        link: "https://cutt.ly/QbOik7v",
      },
      {
        image: Accueil_poivrons,
        alt: "Poivrons",
        text: "Tous les poivrons sont verts à l’origine, c’est en fonction de leur maturité qu’ils changent de couleur. Plus un poivron est mûr, plus il est rouge. Le vert est croquant, fruité avec un brin d’amertume, le rouge est doux et presque sucré, quant au jaune, il est tendre, doux et juteux.",
  ...
  },
  {
    ...
    path: "/boissons",
    imageAlt: "Boissons",
    colors: ["rgba(200, 35, 35, 0.78)", "rgba(200, 35, 35, 1)"],
    descriptions: [
      {
        image: Accueil_mojito,
        alt: "Mojito",
        text: "Le mojito est le cocktail le plus consommé en France. Il suffit de jeter un œil aux terrasses des bars, en été, pour réaliser que cette boisson compte de nombreux adeptes de tout âge. Composé de rhum, d’eau gazeuse, de citron et de feuilles de menthe, le mojito est une boisson incontournable et rafraîchissante.",
        link: "https://www.atelier-cocktail.com/histoire-mojito/",
      },
      {
